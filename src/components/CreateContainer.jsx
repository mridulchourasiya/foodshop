...
const CreateContainer = () => {
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center">
      <div
        className="w-[90%] md:w-[75%] border-gray-200 rounded-lg p-4 flex 
      ...
      >
        ...
        <div className="w-full">
         ...
         border-b-2 border-gray-200 p-2 rounded-md cursor-pointer"
          >
        ...
        border-2 border-dotted border-gray-300 w-full h-225 md:h-340
        ...
        <div className="w-full flex flex-col md:flex-row items-center gap-3">
         ...
         items-center gap-2"
          >
           ...
           border-none placeholder:text-gray-40 text-textColor"
            />
          </div>
          <div
            className="w-full py-2 border-b border-gray-300 flex 
